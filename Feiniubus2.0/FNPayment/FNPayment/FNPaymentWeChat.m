...
@interface FNPaymentWeChat ()<WXApiDelegate>
{
//    NSString *appId;
//    NSString *secret;
...
@implementation FNPaymentWeChat
 ...
 *  @return 类实例
 */
+(FNPaymentWeChat*)instance
{
    static FNPaymentWeChat *instance = nil;
    static dispatch_once_t once_t;
    dispatch_once(&once_t, ^{
        instance = [FNPaymentWeChat new];
    });
...
{
    [WXApi registerApp:appId withDescription:@"feiniubus_app"];
}
...
-(void)payOrder:(FNPayOrder*)order controller:(UIViewController*)controller result:(void(^)(int))result
{
    ...
    FNWeChatOrder *or = (FNWeChatOrder*)order;
    if (!or) {
        return;
    }
