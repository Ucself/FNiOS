...
#import "FNPaymentBase.h"
#import "FNPayOrder.m"


@implementation FNPaymentBase
 ...
 *  支付
 */
-(void)payOrder:(FNPayOrder*)order
{
    
}

-(void)payOrder:(FNPayOrder*)order result:(void(^)(int))result
{
...
-(PayRetCode)returnCodeConversion:(int)returnCode{
    PayRetCode payReturn;
    switch (returnCode) {
        case 9000:
            payReturn = PaySuccess; //支付宝的成功
            break;
        case 8000:
            payReturn = ErrCodePayProcessing; //支付宝正在处理中，支付结果未知（有可能已经支付成功），请查询商户订单列表中订单的支付状态
            break;
        case 4000:
        ...
        case 6001:
            ...
            break;
        case 6002:
            payReturn = ErrCodeCommon; //支付宝网络连接出错
            break;
        case 6004:
            payReturn = ErrCodePayProcessing; //支付结果未知（有可能已经支付成功），请查询商户订单列表中订单的支付状态
            break;
        case 0:
