...
//微信状态
typedef NS_ENUM(int, PayRetCode)
{
    PaySuccess = 0,
...
/*********************************************************************/
#pragma mark- 微信订单类
@interface FNWeChatOrder : FNPayOrder
...
/*********************************************************************/
#pragma mark- 支付宝订单类
@interface FNAliOrder : FNPayOrder
...
/*********************************************************************/
#pragma mark- 一网通订单类
@interface FNUnionOrder : FNPayOrder
