...
+ (NSInteger)lastMonthDays
{
    ...
    [comp setDay:1];
    NSDate *first = [calendar dateFromComponents:comp];
    
    NSRange totaldaysInMonth = [[NSCalendar currentCalendar] rangeOfUnit:NSCalendarUnitDay inUnit:NSCalendarUnitMonth forDate:first];
    return totaldaysInMonth.length;
}
...
+ (NSInteger)nextMonthDays
{
    ...
    [comp setMonth:comp.month+1];
    NSDate *next = [calendar dateFromComponents:comp];
    
    NSRange totaldaysInMonth = [[NSCalendar currentCalendar] rangeOfUnit:NSCalendarUnitDay inUnit:NSCalendarUnitMonth forDate:next];
    return totaldaysInMonth.length;
}
...
+ (NSInteger)firstWeekdayInLastMonth
{
    ...
    NSDate *firstDayOfMonthDate = [self firstDayInLastMonth];
    NSUInteger firstWeekday = [calendar ordinalityOfUnit:NSCalendarUnitWeekday inUnit:NSCalendarUnitWeekOfMonth forDate:firstDayOfMonthDate];
    return firstWeekday - 1;
}
