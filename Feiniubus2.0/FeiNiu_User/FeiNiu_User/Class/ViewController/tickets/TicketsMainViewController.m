...
@interface TicketsMainViewController ()<BannerViewDelegate,SelectDestViewControllerDelegate,UITableViewDelegate,UITableViewDataSource,MAMapViewDelegate,AMapSearchDelegate>
{
    int pageType;
    //出发地的数据
