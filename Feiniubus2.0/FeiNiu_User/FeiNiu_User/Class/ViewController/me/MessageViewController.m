...
@interface MessageViewController ()<UserCustomAlertViewDelegate>
...
{
    UserCustomAlertView *alert = [UserCustomAlertView alertViewWithTitle:@"提示" message:@"确定清空全部消息吗？" delegate:self buttons:@[@"取消",@"确定"]];
