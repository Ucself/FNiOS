...
+ (void)addAPNSMessage:(NSDictionary *)message{
    ...
    if (aps) {
        NSDictionary *dic = @{kAPNSItemDate:[DateUtils formatDate:[NSDate date] format:@"yyyy-MM-dd HH:mm:ss"], kAPNSItemMessage:[NSString stringWithFormat:@"%@", aps[@"alert"]], kAPNSItemIsRead:@NO};
