...
- (id)initWithFrame:(CGRect)frame {
	...
	{
		[self setBackgroundColor:UITranslucentBKColor];
        viewBK = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 130, 70)];
        ...
        ivProgress.animationDuration = 1.0;
...
- (void)layoutSubviews
{
    ...
    ivProgress.frame = CGRectMake((frame.size.width-58)/2, 15, 58, 10);

    textLabel.frame = CGRectMake(0,
                                 ivProgress.frame.origin.y + 15,
                                 frame.size.width,
                                 30);
