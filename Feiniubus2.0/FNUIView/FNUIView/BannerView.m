...
//  Copyright (c) 2014年 mac.com All rights reserved.
//
...
- (void)initUI
{
    ...
    self.pageControl.currentPageIndicatorTintColor = UIColor_DefOrange;
...
//    [imageView setImageWithURL: [NSURL URLWithString:url]];
    [imageView setImageWithURL:[NSURL URLWithString:url] placeholderImage:[UIImage imageNamed:self.placeholderImage]];
