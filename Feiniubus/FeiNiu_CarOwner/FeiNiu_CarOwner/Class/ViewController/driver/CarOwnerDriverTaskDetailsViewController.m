...
@interface CarOwnerDriverTaskDetailsViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    //第几页
    int page;
    //一页数量
...
@implementation CarOwnerDriverTaskDetailsViewController
...
-(void)requestData
{
    ...
    [self startWait];
    [[ProtocolCarOwner sharedInstance] getInforWithNSDictionary:requestDic urlSuffix:Kurl_charterOrderDriverTask requestType:KRequestType_charterOrderDriverTask];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 2:
        {
            ...
            //驾驶员
            UILabel *driverPlateLabel = (UILabel*)[tempCell viewWithTag:102];
            driverPlateLabel.text = taskModel.licensePlate;
        }
            break;
        default:
            break;
