...
#import "CarOwnerGuideViewController.h"
#import <FNDataModule/EnvPreferences.h>
#import <FNCommon/FNCommon.h>
#import "ProtocolCarOwner.h"


@interface CarOwnerGuideViewController ()<UITableViewDelegate>{
    //guide1
...
@implementation CarOwnerGuideViewController
...
- (IBAction)btnToLoginClick:(id)sender {
    ...
    UITabBarController *mainController = [storyboard instantiateViewControllerWithIdentifier:@"mainViewControllerIdent"];
