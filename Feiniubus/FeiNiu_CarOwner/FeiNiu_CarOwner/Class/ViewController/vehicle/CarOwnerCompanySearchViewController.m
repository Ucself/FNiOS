...
@interface CarOwnerCompanySearchViewController()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>
{
    //原始数据
...
@implementation CarOwnerCompanySearchViewController
...
-(UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    tempLabel.text = [[NSString alloc] initWithFormat:@"    %@",filterAllKeys[section]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //返回选择的值
    if ([self.delegate respondsToSelector:@selector(seachCompanySelected:)]) {
        [self.delegate seachCompanySelected:selectObjet];
    }
    //取消选中
...
-(void)httpRequestFinished:(NSNotification *)notification
{
    ...
    NSDictionary *result = resultParse.data;
