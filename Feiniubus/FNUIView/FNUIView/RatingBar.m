...
-(void)setImageDeselected:(NSString *)deselectedName halfSelected:(NSString *)halfSelectedName fullSelected:(NSString *)fullSelectedName andDelegate:(id<RatingBarDelegate>)delegate{
    ...
    {
        [_s1 setFrame:CGRectMake(0,         0, width, height)];
        [_s2 setFrame:CGRectMake(width +_interval,     0, width, height)];
        [_s3 setFrame:CGRectMake(2 * (width+_interval), 0, width, height)];
        [_s4 setFrame:CGRectMake(3 * (width+_interval), 0, width, height)];
        [_s5 setFrame:CGRectMake(4 * (width+_interval), 0, width, height)];
    }
