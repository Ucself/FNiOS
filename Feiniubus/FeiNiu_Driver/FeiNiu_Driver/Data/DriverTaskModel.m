...
@implementation DriverTaskModel
...
-(id)initWithDictionary:(NSDictionary*)dictionary
{
    ...
    if (self) {
        ...
        //车辆牌照
        self.licensePlate = [dictionary objectForKey:@"licensePlate"] && ![[dictionary objectForKey:@"licensePlate"] isKindOfClass:[NSNull class]] ? [dictionary objectForKey:@"licensePlate"] : @"";
        //司机名称
